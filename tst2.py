...
------------使用示例二：对用户回复的消息解密---------------
	...
	*/
"""
wxc = WXBizMsgCrypt(token, encoding_aeskey, receiver_id)
# 1616140317555161061
print(wxc.VerifyURL(verify_msgsig, verify_timestamp, verify_nonce, verify_echostr))
...
encrypt_msg, crypt_err = wxc.EncryptMsg(resp_data, req_nonce, req_timestamp)
print('---' * 30)
print(encrypt_msg, crypt_err)
